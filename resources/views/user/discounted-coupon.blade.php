            ...
            <div class="coll-2">
                ...
                <div class="check__boxes">
                    <a href="{{ route('discounted-coupons') }}" class="check__box">
                        <input type="checkbox" name="" id="" class="bg-success">
                                ...
                                @foreach ($couponsData as $coupon)
                                    <div class="d-flex mb-4">
                                        ...
                                        <span class="me-2 nearby">( <del
                                                ...
                                                class="dispri">${{ $coupon->discounte_price }}</span> )
                                            </span>
                                            <span class="me-2 actpr"><a href="{{route('edit-coupon',[$coupon->id])}}">Edit</a></span>
                                    </div>
                                @endforeach
                            @else
